...
The nodes in purple are not running. To disable a node, simply right-click on it and select the Bypass option, as shown below.

<p align="center">
    <img width="400" src="https://github.com/user-attachments/assets/aebba792-fac5-4f9b-b793-88e253df8b71" />
</p>

The background box (named *UPSCALE* in the image below) serves only to create a visual separation of a group of nodes. To create one, simply right-click on the empty space and select the Add Group option.
